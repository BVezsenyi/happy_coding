...
static void  check_fn_id_validity( FUNCTION_ID_LIST );

void* get_function_pointer_by_id( FUNCTION_ID_LIST fn_id )
{
...
static void check_fn_id_validity( FUNCTION_ID_LIST fn_id )
{    
